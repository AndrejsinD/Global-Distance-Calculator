######################################################################
# Author: Emily Lovell & Scott Heggen      TODO: Irfan Chowdhury, David Andrejsin
# Username: lovelle & heggens              TODO: Chowdhuryi, Andrejsind
#
...
def main():
    ...
    :return: None
    """
    in_filename = input("What is the input filename? (Press enter to use the default: 'io_input.txt') ")
    ...
    out_filename = input("What do you want the output filename to be? (Press enter to save to default: 'io_output.txt') ")
